...
exports.discreteExp = void 0;
const discreteExp = (base, exponent, mod) => {
    if (Number.isInteger(base) === false || Number.isInteger(exponent) === false || Number.isInteger(mod) === false || base <= 0 || exponent <= 0 || mod <= 0)
        return null;
    let tempValue = 1;
...
exports.discreteExp = discreteExp;
